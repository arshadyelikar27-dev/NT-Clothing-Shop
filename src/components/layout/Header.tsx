...
export function Header() {
  ...
  return (
    <>
      {/* ─── Floating Pill Capsule Nav (Zero White Space on Top) ─── */}
      <header
        style={{
          position: "fixed",
          top: "16px",
        ...
        >
          <div
            style={{
              ...
              boxShadow: scrolled
                ? "0 16px 40px -4px rgba(0, 0, 0, 0.16), 0 4px 12px rgba(0,0,0,0.06)"
          ...
          >
            ...
            >
              ...
              >
                ...
                <span
                  ...
                  className="group-hover:text-[#9E3B2B]"
                >
                  NOBLE TEXTILE
                </span>
              </Link>
              ...
              {NAV_LINKS.map((link) =>
                link.children ? (
                  ...
                  >
                    ...
                    {/* Mega Dropdown with Invisible Bridge */}
                    {megaMenuOpen && (
                      <div
                        style={{
                          position: "absolute",
            ...
            {/* ─── Right: Professional Circular Icon Actions Only ─── */}
            <div
              style={{
                display: "flex",
                alignItems: "center",
            ...
            >
              ...
              <button
                ...
                className="hover:bg-black/10 hover:scale-105 active:scale-95"
              >
                <Search size={18} />
              </button>
              ...
              <button
                ...
                className="hover:bg-[#9E3B2B] hover:scale-105 active:scale-95"
              >
                <ShoppingBag size={18} />
                {cartItemCount > 0 && (
                  <span
